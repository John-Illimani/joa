  ...
  return (
    <div>
      <div className="block text-center">
        <h1 className="text-6xl font-bold text-white tracking-wide shadow-lg bg-gradient-to-br from-blue-500 to-purple-700 p-4 rounded-lg">
          COCOMO II
        </h1>
      </div>
      <div className="max-w-lg mx-auto bg-gradient-to-br from-blue-200 to-purple-300 p-8 rounded-lg shadow-lg">
